...
| Intro panel with the site description | about | 1250 | full-width pink panel, 40px type | same | fixed | | seeded as the first paragraph; theme styles it |
| Body type | about, privacy | 1250 | 24px | 24px | fixed | | |
| Title and subtitle | privacy | 1250 | "Privacy Policy" plus the subtitle standfirst | same | fixed | | seed uses TD's front matter |
