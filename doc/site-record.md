...
Slug: trans-dimension. This is production's existing slug, so confirm it rather than accepting whatever the site name autogenerates. The check task defaults to it.
